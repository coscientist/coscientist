...
脳腐敗の回復（Un-brain-rotting）とは、劣化した情報環境にさらされた後、検証能力と認知的主体性（cognitive agency）を能動的に取り戻すプロセスである。これはドリフト（drift）の反対だ。つまり、[AI slop](./ai-slop) を受動的に吸収して流暢さを真実として扱うのではなく、利用者が意図的に、精査・出典確認・反駁（rebuttal）の習慣を再構築する。
