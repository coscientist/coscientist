...
description: مدل زبانی بزرگ، معماریِ هوش مصنوعیِ زیربنای کارِ تأملِ Coscientist
---
...
برای [Coscientist](./coscientist)، LLMها موتورِ انجامِ [کارِ تأمل](./contemplation-labor) هستند: پیشنهاد فرضیه‌ها، گردآوری شواهد، یافتن نقض‌ها، و ساختاردهیِ استدلال‌ها. چون LLMها می‌توانند هر زبانی را بخوانند، [ترکیبِ میان‌زبانی](./cross-linguistic-synthesis) را به‌عنوان یک قابلیت بومی ممکن می‌کنند.
