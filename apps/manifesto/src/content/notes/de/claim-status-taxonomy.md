...
description: Die Zustände, in denen sich ein Anspruch innerhalb eines dialektischen Graphen befinden kann
---

Die Taxonomie des Anspruchsstatus definiert die Zustände, die ein [Anspruch](./claim) in einem [Dialektischen Graphen](./dialectical-graph) einnehmen kann.
...
- `obsolete` — Bedeutung verloren durch [Definitionsdrift](./definition-drift) oder Methodenwechsel
