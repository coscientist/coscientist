...
검증에서의 바람직한 어려움이란 [검증](./verification)이 진짜 인지를 촉발할 만큼 충분히 노력 들게 이루어져야 한다는 원칙이다. 어떤 주장을 확인하는 일이 너무 쉬워져—그저 "AI가 그렇게 말했으니까"로 환원된다면—[운영자](./operator)는 학습하거나 검증하는 것이 아니라, 승인만 하고 있는 것이다.
