...
Extracranial ist [Sunghyun Cho](./sunghyun-cho)s persönliches digitales Gehirn: ein Static-Site-Publishing-System mit automatisierten Links (einschließlich Backlinks) und kontrolliertem Verfall. Alte Notizen verblassen, sofern sie nicht ausdrücklich dauerhaft aktuell (evergreen) gehalten werden. Es wird als ein „Exosuit für [Superbrains](./superbrain)" beschrieben.
