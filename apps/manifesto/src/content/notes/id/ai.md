...
- [Halusinasi](./hallucination) — keluaran yang masuk akal tetapi direkayasa
- [AI Slop](./ai-slop) — konten hasil generasi berkualitas rendah
- [Jebakan Kefasihan](./fluency-trap) — mengira prosa yang mulus sebagai akurasi
- [Keruntuhan Model](./model-collapse) — degradasi akibat pelatihan-diri
