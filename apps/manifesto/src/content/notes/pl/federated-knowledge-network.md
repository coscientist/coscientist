...
Kluczowym ograniczeniem jest [pobieranie w modelu zero-trust](./zero-trust-ingestion): importowane twierdzenia muszą nieść [pochodzenie (provenance)](./provenance) i przejść lokalną [weryfikację](./verification). Suwerenność pozostaje po stronie [Operatora](./operator) każdego węzła; sieć zwiększa zasięg bez centralizowania autorytetu.

Federacja umożliwia także [wielojęzyczną siatkę wiedzy](./multilingual-knowledge-mesh): węzły działające w różnych [Sprachraumach](./sprachraum) mogą wymieniać zweryfikowaną wiedzę [ponad granicami językowymi](./across-the-sprachraums), a [wierność tłumaczenia](./translation-fidelity) jest śledzona jako część pochodzenia. Dzięki temu [synteza międzyjęzykowa](./cross-linguistic-synthesis) staje się zdolnością na poziomie sieci, a nie tylko lokalną.