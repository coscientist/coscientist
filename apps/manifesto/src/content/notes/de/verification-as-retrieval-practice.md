...
description: Der Verifikationskreislauf des Operators als Form des aktiven Abrufs, der die Wissensspeicherung stärkt
---

Verifikation als Abrufübung ist die Einsicht, dass die Verifikationsarbeit des [Operators](./operator) selbst eine Form des [aktiven Abrufs](./active-recall) ist. Wenn du eine [Behauptung](./claim) bis zu ihrer [Evidenzspanne](./evidence-span) zurückverfolgst, nach [Gegenbeispielen](./counterexample) suchst und die [Verantwortungslinie](./responsibility-line) bewertest, übst du Abruf – nicht passive Aufnahme.
