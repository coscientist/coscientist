...
description: A standardized claim extracted from natural language text
---

A normalized proposition is a [claim](./claim) that has been extracted from natural language and rewritten in a standardized form with explicit [scope](./scope), [assumptions](./assumption), and dependencies. Normalization removes ambiguity so that claims can be compared, linked, and challenged consistently.
