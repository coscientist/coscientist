...
- Przekraczanie lingwistycznego wszechświata — wiedza powinna być dostępna niezależnie od języka.
- Odrywanie idei od języka — idee należą do ludzkości, a nie do języka, który jako pierwszy je wyraził.
- [Komunikacja inter-Sprachraum](./inter-sprachraum-communication) — umożliwianie dialogu między domenami językowymi bez utraty niuansów.
