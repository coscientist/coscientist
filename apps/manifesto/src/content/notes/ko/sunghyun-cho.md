...
조성현은 [Coscientist](./coscientist)의 제작자이며, 그 방향성을 형성한
...
대한 그의 비전을 뒷받침한다. 언어 경계를 넘어서는 지식 시스템. 이 다국어의 꿈은
[프로젝트 PIRI](./project-piri)(AI 코딩 에이전트가 번역을 불필요하게 만들면서
취소됨)로 구현되었다가, [다국어 메멕스](./multilingual-memex)로서의
[외골격두뇌](./extracranial) 설계에 계속해서 남아 있다.
[슈퍼브레인](./superbrain) 개념은 언어를 가로질러 인간 지능을 증폭시키는
[인지 외골격](./cognitive-exoskeleton)에 대한 그의 열망을 담아낸다.
