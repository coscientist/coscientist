...
description:
  Uma rede de conhecimento que atravessa idiomas e se distribui globalmente
---
...
o mesmo conceito pela ideia subjacente, e não por sobreposição de
palavras-chave. O [índice agnóstico de idioma](./language-agnostic-indexing)
serve como a espinha dorsal conceitual, permitindo recuperação e conexão
independentemente de qual [Sprachraum](./sprachraum) o conteúdo tenha se
originado.
...
Para o [Cocientista](./coscientist), a malha multilíngue é essencial. A ciência
global abrange muitos idiomas; um colaborador de pesquisa que só consegue ler
inglês é fundamentalmente limitado. O [Grafo Dialético](./dialectical-graph)
pode armazenar [alegações](./claim) de qualquer idioma, com
[proveniência](./provenance) rastreando qual idioma de origem produziu qual
insight.
