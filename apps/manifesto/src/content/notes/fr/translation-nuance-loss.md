...
C’est une préoccupation centrale dans la vision de
[Sunghyun Cho](./sunghyun-cho) à propos de
[à travers les Sprachraums](./across-the-sprachraums). La traduction automatique
rend possible la production de contenu multilingue à grande échelle, mais elle
rend aussi la perte de nuance systématique. Une traduction fluide peut masquer
des erreurs subtiles, de la même manière que le
...
[affirmation](./claim) est passée par la traduction, conserver la source dans la
langue d’origine au sein de la [provenance](./provenance), et signaler les
endroits où des nuances ont pu être perdues. La [vérification](./verification)
de contenus traduits devrait inclure un contrôle du maintien du sens visé, et
pas seulement des mots au pied de la lettre.

Pour la vision de l’[Encyclopédie Galactica](./encyclopedia-galactica), la perte
de nuance en traduction est un risque existentiel : une encyclopédie qui traduit
avec négligence propagera des distorsions à grande échelle. La souveraineté du
savoir doit inclure la souveraineté de remettre en question le fait qu’une
traduction ait réellement saisi ce qui était voulu.
