...
Gerçek [doğrulama](./verification), iddiaları eğitim dağılımı dışındaki bağımsız [kaynaklara](./source) ve [kanıt aralıklarına](./evidence-span) (evidence spans) kadar izlemeyi gerektirir. [Operatör](./operator), AI uzlaşmasına karşı şüpheci kalmalı ve yüksek riskli iddialar için dış doğrulama aramalıdır.