...
- [Ingestia w modelu zero trust](./zero-trust-ingestion) — wymaganie proweniencji przed autorytetem

System zaprojektowano tak, aby [korekta była tańsza niż dryf](./correction-vs-drift) oraz by wspierać [pożądaną trudność](./desirable-difficulty-in-verification), tak aby [Operator](./operator) pozostawał zaangażowany.