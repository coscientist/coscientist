...
- [Vloeiendheidsval](./fluency-trap) — soepele proza verwarren met nauwkeurigheid
- [Modelinstorting](./model-collapse) — achteruitgang door zelftraining

## Mens-AI-relaties

- [Operator](./operator) — de menselijke soeverein
- [Cognitieve soevereiniteit](./cognitive-sovereignty) — mensen de controle laten houden
- [Ontvaardiging door AI-delegatie](./deskilling-through-ai-delegation) — risico op verschraalde vaardigheden
- [Door AI veroorzaakte competentie-illusies](./ai-induced-illusions-of-competence) — valse beheersing