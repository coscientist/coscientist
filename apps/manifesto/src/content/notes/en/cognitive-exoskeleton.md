---
title: Cognitive Exoskeleton
description: External tools that extend and amplify human cognition
---
...
[Vannevar Bush](./vannevar-bush)'s [Memex](./memex) was an early vision of such an exoskeleton. [Coscientist](./coscientist) aims to be a more capable one: not just storing and linking, but performing [contemplation labor](./contemplation-labor), surfacing contradictions, and defending against [Encyclopedia Meltdown](./encyclopedia-meltdown) while preserving [cognitive sovereignty](./cognitive-sovereignty). The [Superbrain](./superbrain) vision extends this to a [multilingual knowledge mesh](./multilingual-knowledge-mesh) that operates [across the Sprachraums](./across-the-sprachraums), thinking in multiple languages simultaneously.
