...
Pre-LLM 텍스트는 대규모 언어 모델이 그럴듯한 산문을 대규모로 생성할 수 있게 되기 전—대략 2020년 이전—에 사람이 직접 작성한 콘텐츠를 말합니다. 그 가치는 검증된 [출처](./provenance)에 있습니다. 즉, 합성물이 아니고, AI 출력에서 재귀적으로 파생된 것도 아닌, 명백한 인간 작성물입니다.
