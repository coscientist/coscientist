...
En [Cocientífico](./coscientist), la deriva se registra explícitamente separando
los objetos de definición de las afirmaciones. Cuando un término cambia de
significado, las afirmaciones antiguas pueden marcarse como obsoletas debido a
la [pérdida de significado](./meaning-loss) o re-delimitarse, en lugar de
mezclarse silenciosamente en un único «consenso».
