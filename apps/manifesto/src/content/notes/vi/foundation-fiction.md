...
- [Con tàu tri thức](./knowledge-ark) — các kho lưu trữ được thiết kế để sống sót qua sụp đổ

## Nhận định then chốt

- [Từ bảo tồn đến năng lực](./from-preservation-to-capability) — sự chuyển dịch từ lưu trữ sang tạo ra sự thấu hiểu

Bộ bách khoa thư hư cấu là một mục tiêu thiết kế: cần những gì để xây dựng một hệ thống thực có thể sống sót trong một môi trường nhận thức luận bão hòa bởi AI và vẫn tạo ra tri thức chân thực?
