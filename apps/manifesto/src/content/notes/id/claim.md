---
title: Klaim
description: Proposisi yang dapat diverifikasi dan disimpan sebagai node dalam graf dialektik
---

Klaim adalah proposisi yang dapat diverifikasi yang diekstrak dari teks dan disimpan sebagai objek kelas-satu dalam [Graf Dialektik](./dialectical-graph). Klaim bukanlah kalimat mentah; melainkan pernyataan yang dinormalisasi dengan ketergantungan [cakupan](./scope), [asumsi](./assumption), dan [metode](./method) yang eksplisit.
