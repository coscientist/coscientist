...
[Encyclopedia Meltdown](./encyclopedia-meltdown) is what happens when drift wins permanently: the system stabilizes around an "approximately maintained" false steady state because no one can afford to clean it up.
