---
title: Personal to Institutional Knowledge
description: Scaling personal knowledge practices to organizations
---

Personal to institutional knowledge is the transition from a [digital brain](./digital-brain) serving one person to a system serving a team, lab, or organization. What works for personal notes does not automatically scale: governance, shared vocabulary, and trust boundaries become first-order concerns.
