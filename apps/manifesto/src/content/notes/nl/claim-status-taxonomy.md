...
description:
  De toestanden waarin een claim zich kan bevinden binnen een dialectische graaf
---

De taxonomie van claimstatus definieert de toestanden die een [claim](./claim)
kan innemen in een [Dialectische Graaf](./dialectical-graph).
...
- `obsolete` — betekenis verloren door
  [definitieverschuiving](./definition-drift) of een methodologische
  verschuiving
