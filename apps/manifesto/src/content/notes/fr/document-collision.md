...
description: Protocole visant à forcer des sources disparates à se confronter aux [prétentions](./claim) des autres
---

La collision de documents est le protocole consistant à forcer des sources disparates à se confronter aux [prétentions](./claim) des autres plutôt qu’à simplement les résumer en parallèle. Lorsque des documents entrent en collision, les contradictions deviennent visibles, les définitions doivent être harmonisées, et la [controverse](./contention) est mise au jour comme un objet explicite.
