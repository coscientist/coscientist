...
Ini adalah keterbatasan yang sudah dikenal dari [Protokol Konsensus Multi-AI](./multi-ai-consensus-protocol). Protokol tersebut memperlakukan ketidaksepakatan model sebagai tanda bahaya (red flag), tetapi kesepakatan hanya memberikan jaminan yang lemah karena model-model tersebut bukan pengamat yang independen.
