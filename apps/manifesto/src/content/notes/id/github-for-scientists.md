...
"GitHub untuk Ilmuwan" adalah sebuah visi di mana eksperimen ilmiah diperlakukan seperti kode: diberi versi, dapat diulang, dan dapat diaudit. Sama seperti rekayasa perangkat lunak beralih dari skrip ad-hoc ke integrasi berkelanjutan (continuous integration) dan kontrol versi, sains dapat beralih dari catatan lab sekali pakai (one-off) ke pipeline yang dapat direproduksi dengan pelacakan asal-usul (provenance tracking).
