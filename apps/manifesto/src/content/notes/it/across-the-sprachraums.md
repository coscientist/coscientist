...
"Across the Sprachraums" è la visione di [Sunghyun Cho](./sunghyun-cho) per sistemi di conoscenza che trascendono i confini linguistici. L’espressione combina una preposizione inglese con un sostantivo tedesco per incarnare il suo stesso significato: nessun singolo [Sprachraum](./sprachraum) dovrebbe vincolare il modo in cui la conoscenza fluisce.

La visione ha tre parti:

- Attraversare l’universo linguistico — la conoscenza dovrebbe essere accessibile indipendentemente dalla lingua.
- Svincolare le idee dalla lingua — le idee appartengono all’umanità, non alla lingua che le ha espresse per prima.
- [Comunicazione inter-Sprachraum](./inter-sprachraum-communication) — abilitare il dialogo tra domini linguistici senza perdere sfumature.
