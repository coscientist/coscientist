...
"과학자를 위한 GitHub"는 과학 실험을 코드처럼 다루는 비전이다. 즉, 버전 관리되고, 반복 가능하며, 감사 가능한 것이다. 소프트웨어 공학이 즉흥적인 스크립트에서 지속적 통합과 버전 관리로 옮겨갔듯이, 과학도 일회성 실험 노트에서 출처 추적을 갖춘 재현 가능한 파이프라인으로 이동할 수 있다.
