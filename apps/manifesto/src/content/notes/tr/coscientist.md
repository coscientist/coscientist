...
[Galaktik Ansiklopedi](./encyclopedia-galactica) eserinden ilham alan açık
kaynaklı bir servistir. Yalnızca bilgiden oluşan bir
[bilgi gemisi](./knowledge-ark) olmaktan fazlası olması amaçlanır: insan
[Operatör](./operator) ile birlikte [tefekkür emeği](./contemplation-labor)
yürüten bir [entelektüel yoldaş](./intellectual-companion). Yapay zekâ sonrası
çağda hedefi, [beyin çürütmeme](./un-brain-rotting) sürecini desteklemektir:
...
İlk ilke egemenliktir: bilgi otoritesi [Operatör](./operator)'de kalmalıdır.
[Ansiklopedi Çöküşü](./encyclopedia-meltdown)'a karşı korunmak sonradan eklenen
...
[bilgi sentezi](./knowledge-synthesis) gibi prosedürler kullanır.
[LLM’ler](./llm) kullandığı için Coscientist
[diller arası sentez](./cross-linguistic-synthesis) gerçekleştirebilir: herhangi
bir dildeki literatürü okuyup sentezleyerek gerçek anlamda
[çok dilli bir bilgi ağı](./multilingual-knowledge-mesh) mümkün kılar.
Hedeflenen nihai durum, argümanlardan oluşan bir ekosistemdir: Yapay zekâ arama
ve yeniden yapılandırmayı üstlenirken, Operatör yapıyı ve doğrulamayı denetler;
böylece ortaya çıkan anlatı izlenebilir kalır.
