...
Nos romances de Arthur C. Clarke, os alienígenas semearam Monólitos
pela galáxia como instrumentos de elevação. Os macacos que o
...
ecoam as proporções do Monólito: lajes verticais empilhadas horizontalmente,
cada uma contendo conhecimento que transforma a compreensão.
...
No filme, tocar o Monólito precede a transformação. Nesta base de conhecimento,
clicar em um link abre um novo painel — um pequeno ato que pode levar à evolução
conceitual.

## A Trilogia de Encontros
