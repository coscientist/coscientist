...
description: Tryb awarii organizacyjnej, w którym degraduje się zbiorowa zdolność weryfikacji
---

Instytucjonalna zgnilizna mózgu to tryb awarii, w którym zbiorowa zdolność organizacji do weryfikowania i aktualizowania wiedzy z czasem ulega degradacji. Różni się ona od [Załamania encyklopedii](./encyclopedia-meltdown), które jest załamaniem na poziomie systemu wywołanym skażeniem przez AI; zgnilizna mózgu jest zjawiskiem ludzkim i organizacyjnym.
