...
description: Principio economico secondo cui un sistema di conoscenza sopravvive solo se il costo della correzione resta inferiore al costo della deriva
---

Correzione vs deriva è il principio economico secondo cui un sistema di conoscenza rimane sano solo se il costo di correggere gli errori resta inferiore al costo di lasciarli propagare. Quando la correzione diventa costosa (socialmente, computazionalmente o a livello organizzativo), vince la deriva: gli errori persistono perché non vale la pena di correggerli.
