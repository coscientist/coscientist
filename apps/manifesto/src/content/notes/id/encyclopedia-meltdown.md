...
Kehancuran Ensiklopedia adalah mode kegagalan keruntuhan pengetahuan yang dimulai ketika inisiatif dan kendali penulisan beralih ke AI tanpa intervensi sadar dari [Operator](./operator). Istilah ini berasal dari esai oleh [Sunghyun Cho](./sunghyun-cho).

Kehancuran biasanya muncul dari tiga loop yang saling terkait:

1. **Generasi → sitasi**: keluaran model diserap kembali ke dalam korpus dan kemudian dikutip seolah-olah itu adalah fakta eksternal.
2. **Keterkaitan → otoritas**: tautan internal berhenti berfungsi sebagai jalur verifikasi dan menjadi lencana kepercayaan, sehingga kepadatan tautan menggantikan akurasi.
3. **Tanggung jawab → tanpa-agen**: ketika tidak jelas siapa menyatakan apa atas dasar apa, koreksi menjadi mahal, dan sistem menstabilkan diri di sekitar kondisi mantap palsu yang "dipelihara secara kira-kira".
