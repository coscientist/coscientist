...
description: Loop verifikasi Operator sebagai bentuk active recall yang memperkuat retensi pengetahuan
---

Verifikasi sebagai latihan pengambilan kembali adalah wawasan bahwa pekerjaan verifikasi [Operator](./operator) itu sendiri merupakan bentuk [active recall](./active-recall). Saat Anda menelusuri sebuah [klaim](./claim) kembali ke [rentang buktinya](./evidence-span), memeriksa [contoh tandingan](./counterexample), dan mengevaluasi [garis tanggung jawab](./responsibility-line), Anda sedang melatih pengambilan kembali, bukan konsumsi pasif.
