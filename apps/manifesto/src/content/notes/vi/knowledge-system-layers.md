...
- [Lớp Suy luận](./inference-layer) — mạng lưới sống, không ngừng tiến hoá của các mệnh đề và quan hệ
- [Mệnh đề](./claim), [Phản công](./attack), [Phản bác nền tảng](./undercut), và các [Quan hệ lập luận](./argumentative-relations) khác
...
- [Lớp Giao thức Nhận thức luận](./epistemic-protocol-layer) — quy tắc về cách các mệnh đề được đưa vào và giành được thẩm quyền
- [Hiến chương Tri thức](./knowledge-constitution) — văn bản quản trị cho các hoạt động tri thức

## Nguyên tắc Tách biệt

- [Tách biệt ba phần](./triple-separation) — giữ văn bản thô, các mệnh đề đã chuẩn hoá, và các quan hệ tách biệt nhau