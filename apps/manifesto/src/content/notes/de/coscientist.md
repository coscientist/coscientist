...
title: Coscientist
description:
  Ein intellektuelles Begleitsystem für Wissensproduktion in der Post-AI-Ära
---

Coscientist ist ein Open-Source-Dienst, inspiriert von
[Isaac Asimov](./isaac-asimov)s fiktiver
[Enzyklopädie Galactica](./encyclopedia-galactica). Es soll mehr sein als eine
...
[Wissenssynthese](./knowledge-synthesis), um Dokumente kollidieren zu lassen,
statt sie lediglich zusammenzufassen. Da es [LLMs](./llm) verwendet, kann
Coscientist [cross-linguistische Synthese](./cross-linguistic-synthesis)
durchführen: Literatur in jeder Sprache lesen und synthetisieren und damit ein
wirklich [mehrsprachiges Wissensmesh](./multilingual-knowledge-mesh)
ermöglichen. Der angestrebte Endzustand ist ein Ökosystem von Argumenten: KI
übernimmt Suche und Umstrukturierung, während der Operator Struktur und
Verifikation überwacht, sodass die entstehende Erzählung nachvollziehbar bleibt.
