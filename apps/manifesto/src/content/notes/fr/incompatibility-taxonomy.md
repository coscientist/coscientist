...
La taxonomie des incompatibilités est une classification des raisons pour lesquelles les sources sont en désaccord. Les catégories incluent les différences de définition (même mot, concepts différents), les différences d’échantillonnage (populations ou conditions différentes), les différences de méthode (procédures différentes), la dérive de périmètre (des affirmations qui s’appliquent à des contextes différents) et la [non-stationnarité](./nonstationarity) (le monde a changé entre les études).
