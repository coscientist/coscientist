...
In [Kozientist](./coscientist) wird Drift explizit nachverfolgt, indem
Definitionsobjekte von Behauptungen getrennt werden. Wenn ein Begriff seine
Bedeutung ändert, können alte Behauptungen aufgrund von
[Bedeutungsverlust](./meaning-loss) als obsolet markiert oder neu abgegrenzt
