...
Tartışmacı ilişkiler, bir [Diyalektik Graf](./dialectical-graph) içindeki, epistemik nesnelerin birbirleriyle nasıl ilişkilendiğini kodlayan kenar türleridir. Bir diyalektik grafi, konu-benzerliği grafından ayıran şey de bunlardır.
...
- `defines` — terimleri tanımlarına bağlar (zaman içinde [Tanım Kayması](./definition-drift) üzerinden izlenir)

Tam belirtim için [Diyalektik Graf Kenarları](./dialectical-graph-edges)na ve türlendirilmiş kenarların neden önemli olduğu için [İlişki Türlendirme ve Benzerlik](./relation-typing-vs-similarity)e bakın.