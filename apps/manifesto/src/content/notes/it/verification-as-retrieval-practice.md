...
description: Il ciclo di verifica dell’Operatore come forma di richiamo attivo che rafforza la ritenzione della conoscenza
---

La verifica come pratica di recupero è l’intuizione secondo cui il lavoro di verifica dell’[Operatore](./operator) è esso stesso una forma di [richiamo attivo](./active-recall). Quando risali da un’[affermazione](./claim) al suo [intervallo di evidenza](./evidence-span), cerchi [controesempi](./counterexample) e valuti la [linea di responsabilità](./responsibility-line), stai praticando il recupero, non una fruizione passiva.
