...
[Extracranial](./extracranial), otomatik dil algılama, içerik uzlaşımı ve yerel
ayara özgü sunum için hreflang etiketleri aracılığıyla bunun erken biçimlerini
uygular. Vizyon, sistemin içeriği diller arasında otomatik olarak dağıtması ve
içeriğin hangi dilde üretildiğinden bağımsız olarak güncelliğini yitirmiş
içeriği cezalandırmasıdır.
