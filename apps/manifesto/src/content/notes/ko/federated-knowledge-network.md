...
연합형 지식 네트워크는 개인, 조직, 공공 규모에서 상호연결된 [코사이언티스트](./coscientist) 인스턴스들이 로컬 주권을 보존하면서 검증된 지식을 교환하는 시스템이다. 각 노드는 자체 [변증법 그래프](./dialectical-graph)와 [인식론적 프로토콜 계층](./epistemic-protocol-layer)을 유지하며, 연합(federation)은 통제권을 포기하지 않고도 공유할 수 있는 채널을 제공한다.
