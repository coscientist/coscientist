...
Voor [Coscientist](./coscientist) betekent dit dat de [Dialectische Graaf](./dialectical-graph) in staat moet zijn om beweringen uit verschillende taalbronnen te representeren, bij te houden wanneer ogenschijnlijke onenigheid in feite een vertaalartefact is, en echte [twist](./contention) zichtbaar te maken die taalkundige formulering overstijgt. Het systeem moet onderscheid maken tussen "ze zijn het oneens omdat ze woorden anders gebruiken" en "ze zijn het oneens omdat ze verschillend bewijs hebben."

Dit is ook waarom [taalonafhankelijke indexering](./language-agnostic-indexing) belangrijk is: de conceptuele ruggengraat moet robuust genoeg zijn om te dienen als ontmoetingspunt voor ideeën die in welke taal dan ook worden uitgedrukt.