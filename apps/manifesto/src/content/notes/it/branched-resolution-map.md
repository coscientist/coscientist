...
Le mappe ramificate contrastano la pressione a fare una media. Nel [RAG](./rag) standard, le fonti in conflitto vengono fuse in un riassunto uniforme che nasconde il disaccordo. Una mappa ramificata preserva la struttura del conflitto e permette all’[Operatore](./operator) di decidere quale ramo si applichi al proprio contesto.
