...
「科学者のためのGitHub」とは、科学実験をコードのように扱うビジョンです。つまり、バージョン管理され、再現可能で、監査（audit）できるものとして扱います。ソフトウェア工学が、その場しのぎのスクリプトから継続的インテグレーション（continuous integration）とバージョン管理へと移行したのと同様に、科学も、一回きりのラボノートから、来歴（provenance）追跡を備えた再現可能なパイプラインへと移行しうるのです。
