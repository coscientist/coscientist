...
Temel kısıt, [sıfır-güvenli içe alma](./zero-trust-ingestion) ilkesidir: içe aktarılan iddialar [köken bilgisi](./provenance) taşımalı ve yerel [doğrulamadan](./verification) geçmelidir. Egemenlik, her düğümün [Operatöründe](./operator) kalır; ağ, otoriteyi merkezileştirmeden erişimi artırır.

Federasyon ayrıca [çokdilli bilgi ağı](./multilingual-knowledge-mesh) sağlar: farklı [Sprachraumlarda](./sprachraum) faaliyet gösteren düğümler, [dil sınırları arasında](./across-the-sprachraums) doğrulanmış bilgiyi değiş tokuş edebilir; [çeviri sadakati](./translation-fidelity) köken bilgisinin bir parçası olarak izlenir. Bu, [diller arası sentezi](./cross-linguistic-synthesis) yalnızca yerel bir yetenek olmaktan çıkarıp ağ düzeyinde bir kabiliyete dönüştürür.