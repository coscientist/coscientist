...
Encyclopedia Meltdown is a knowledge-collapse failure mode that begins when the initiative and control of writing shifts to AI without the [Operator](./operator)'s conscious intervention. The term comes from an essay by [Sunghyun Cho](./sunghyun-cho).
