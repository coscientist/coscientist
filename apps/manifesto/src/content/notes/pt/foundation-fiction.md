...
- [Arca do Conhecimento](./knowledge-ark) — repositórios projetados para sobreviver ao colapso

## Insight Fundamental

- [Da Preservação à Capacidade](./from-preservation-to-capability) — a mudança de armazenar para produzir compreensão

A enciclopédia fictícia é um alvo de design: o que seria necessário para construir um sistema real que pudesse sobreviver a um ambiente epistêmico saturado por IA e ainda produzir conhecimento genuíno?