...
Neste Manifesto, a noite escura é também uma metáfora para o colapso civilizacional ou epistémico. A queda do [Império Galáctico](./galactic-empire) de [Isaac Asimov](./isaac-asimov) é uma noite escura civilizacional, e o [Colapso da Enciclopédia](./encyclopedia-meltdown) é um análogo de sistema de conhecimento: quando a verificação colapsa, o sistema precisa de ser reconstruído, e não de mais texto. Uma [arca do conhecimento](./knowledge-ark), como a ficcional [Encyclopedia Galactica](./encyclopedia-galactica), é uma forma de atravessar a noite; o [Coscientist](./coscientist) pretende fazê-lo sem abdicar da soberania.