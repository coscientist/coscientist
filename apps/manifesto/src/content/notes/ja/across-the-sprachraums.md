...
「Across the Sprachraums」は、言語の境界を超える知識システムに関する [Sunghyun Cho](./sunghyun-cho) のビジョンです。このフレーズは英語の前置詞とドイツ語の名詞を組み合わせ、自らの意味を体現しています。いかなる単一の [Sprachraum](./sprachraum) も、知識の流れを制約してはならないのです。

このビジョンは3つの要素から成ります。

- 言語的宇宙を横断する — 言語に関係なく知識へアクセスできるべきだ。
- アイデアを言語から切り離す — アイデアは人類のものであり、最初にそれを表現した言語のものではない。
- [Inter-Sprachraum communication](./inter-sprachraum-communication) — ニュアンスを失うことなく、言語領域（domain）をまたいだ対話を可能にする。
