...
"Across the Sprachraums" adalah visi [Sunghyun Cho](./sunghyun-cho) untuk sistem pengetahuan yang melampaui batas bahasa. Frasa ini menggabungkan sebuah preposisi bahasa Inggris dengan sebuah nomina bahasa Jerman untuk mewujudkan maknanya sendiri: tidak ada satu pun [Sprachraum](./sprachraum) yang seharusnya membatasi bagaimana pengetahuan mengalir.

Visi ini memiliki tiga bagian:

- Menyeberangi semesta kebahasaan — pengetahuan seharusnya dapat diakses terlepas dari bahasa.
- Melepaskan gagasan dari bahasa — gagasan adalah milik umat manusia, bukan milik bahasa yang pertama kali mengungkapkannya.
- [Komunikasi antar-Sprachraum](./inter-sprachraum-communication) — memungkinkan dialog lintas ranah bahasa tanpa kehilangan nuansa.
