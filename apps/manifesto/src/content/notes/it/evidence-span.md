...
description: Un intervallo citato esatto da una fonte che supporta o mette in discussione un'affermazione
---

Un intervallo di evidenza è il testo citato esatto tratto da una fonte che supporta o mette in discussione un'[affermazione](./claim). Preserva la formulazione e il contesto originali, così che i lettori successivi possano vedere che cosa è stato effettivamente detto, non una parafrasi o un riassunto che potrebbe essersi discostato.
