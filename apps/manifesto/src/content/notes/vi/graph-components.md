...
- [Đoạn bằng chứng](./evidence-span) — văn bản được trích dẫn nguyên văn chính xác từ nguồn
...
**Các loại cạnh** (xem [Các cạnh của Đồ thị Biện chứng](./dialectical-graph-edges)):
