...
Warstwa wnioskowania to żywa, ewoluująca sieć [twierdzeń](./claim), [ataków](./attack), [podcięć](./undercut) oraz relacji wspierających w [Grafie Dialektycznym](./dialectical-graph). Reprezentuje ona bieżący stan wiedzy: co jest uznawane, co jest kwestionowane i co zostało obalone.
