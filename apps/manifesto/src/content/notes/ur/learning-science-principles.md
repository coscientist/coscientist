...
سیکھنے کی سائنس کے اصول علم حاصل کرنے کے لیے شواہد پر مبنی تکنیکیں ہیں جو دیرپا رہیں، دوسرے سیاق و سباق میں منتقل ہو سکیں، اور دباؤ کے حالات میں بھی قابلِ رسائی رہیں۔ یہ اصول اس بات کی رہنمائی کرتے ہیں کہ [Coscientist](./coscientist) کس طرح [Operator](./operator) کے علمی کام (cognitive work) کی حمایت کرتا ہے۔
