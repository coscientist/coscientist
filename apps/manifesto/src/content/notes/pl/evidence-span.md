...
Fragment dowodowy to dokładnie zacytowany tekst ze źródła, który wspiera lub podważa [twierdzenie](./claim). Zachowuje oryginalne brzmienie i kontekst, aby późniejsi czytelnicy mogli zobaczyć, co faktycznie zostało powiedziane — a nie parafrazę czy streszczenie, które mogły z czasem odbiec od sensu.
