...
Die Inkompatibilitäts-Taxonomie ist eine Klassifikation der Gründe, warum Quellen voneinander abweichen. Zu den Kategorien gehören Definitionsunterschiede (gleiches Wort, unterschiedliche Konzepte), Stichprobenunterschiede (unterschiedliche Populationen oder Bedingungen), Methodendifferenzen (unterschiedliche Vorgehensweisen), Scope-Drift (Aussagen, die in unterschiedlichen Kontexten gelten) und [Nichtstationarität](./nonstationarity) (die Welt hat sich zwischen den Studien verändert).
