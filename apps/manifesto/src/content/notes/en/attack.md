...
[undercut](./undercut), which targets the grounds, an attack says the claim
...
Not all attacks are equal. A well-sourced counterexample carries more weight
than a bare assertion of disagreement. This is why [Coscientist](./coscientist)
tracks [evidence spans](./evidence-span) and [provenance](./provenance) for
attacks as well as for claims.
