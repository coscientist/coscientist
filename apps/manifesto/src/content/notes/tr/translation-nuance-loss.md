...
kaygısıdır. Makine çevirisi çok dilli içeriği ölçekli biçimde mümkün kılar;
ancak nüans kaybını da sistematik hâle getirir. Akıcı bir çeviri, tıpkı
[akıcılık tuzağının](./fluency-trap) pürüzsüz AI metninin aslında doğru
...
takip etmeli, özgün dil kaynağını [provenance](./provenance) (köken bilgisi)
içinde korumalı ve nüansın kaybolmuş olabileceği yerleri işaretlemelidir.
Çevrilmiş içeriğin [doğrulanması](./verification), yalnızca kelimesi kelimesine
ifadelerin değil, çevirinin amaçlanan anlamı koruyup korumadığının da kontrolünü
içermelidir.

[Galaktik Ansiklopedi](./encyclopedia-galactica) vizyonu için çeviri nüans kaybı
varoluşsal bir risktir: dikkatsizce çeviri yapan bir ansiklopedi, çarpıtmaları
ölçekli biçimde yayar. Bilginin egemenliği, bir çevirinin gerçekten ne
kastedildiğini yakalayıp yakalamadığını sorgulama egemenliğini de içermelidir.
