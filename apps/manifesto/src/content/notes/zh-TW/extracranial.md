...
顱外（Extracranial）是 [趙成賢（Sunghyun Cho）](./sunghyun-cho) 的個人數位大腦：一套靜態網站（static-site）出版系統，具備自動化連結（包含反向連結/backlinks）與可控的衰退（controlled decay）。舊筆記會逐漸淡出，除非被明確保留為常青（evergreen）。它被形容為「[超級大腦（Superbrains）](./superbrain) 的外骨骼（Exosuit）」。
