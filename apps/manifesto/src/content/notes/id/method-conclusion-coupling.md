...
Keterkaitan metode-kesimpulan adalah pola analisis yang mengelompokkan [klaim](./claim) berdasarkan [metode](./method) yang menghasilkan klaim tersebut, alih-alih berdasarkan kesimpulan yang dicapainya. Wawasannya adalah bahwa kesimpulan yang berbeda dapat memiliki cacat yang sama, dan kesimpulan yang identik dapat bertumpu pada landasan yang sangat berbeda.
