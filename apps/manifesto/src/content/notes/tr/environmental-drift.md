...
Çevresel sürüklenme, dış dünyanın değiştiği ve bunun daha önce geçerli olan bilginin eskimesine ya da uygulanamaz hale gelmesine yol açtığı [sürüklenme olguları](./drift-phenomena) kategorisidir.

## Birincil Biçim

- [Durağan olmama](./nonstationarity) — veri üreten sürecin zaman içinde değişmesi
