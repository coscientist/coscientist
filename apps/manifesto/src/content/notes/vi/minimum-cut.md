...
Cắt nhỏ nhất (minimum cut) là tập cạnh nhỏ nhất mà khi loại bỏ sẽ làm ngắt kết nối một đồ thị. Trong một [Đồ thị Biện chứng](./dialectical-graph), phân tích cắt nhỏ nhất có thể được dùng để cô lập cấu trúc tối thiểu tạo ra một mâu thuẫn giữa các cụm khẳng định.
