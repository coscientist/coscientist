...
Dari Memex ke Graf Dialektis menelusuri evolusi sistem pengetahuan pribadi: dari [Memex](./memex) milik [Vannevar Bush](./vannevar-bush), yang menyimpan catatan dan menautkannya melalui jejak asosiatif, hingga [Graf Dialektis](./dialectical-graph), yang menyimpan [klaim](./claim), [bukti](./evidence-span), dan [relasi argumentatif](./argumentative-relations).
