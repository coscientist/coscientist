...
- Das linguistische Universum durchqueren — Wissen sollte unabhängig von der Sprache zugänglich sein.
- Ideen von Sprache lösen — Ideen gehören der Menschheit, nicht der Sprache, die sie zuerst ausgedrückt hat.
- [Inter-Sprachraum-Kommunikation](./inter-sprachraum-communication) — Dialog über Sprachdomänen hinweg ermöglichen, ohne Nuancen zu verlieren.
