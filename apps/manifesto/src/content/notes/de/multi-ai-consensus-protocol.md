...
[Betreiber](./operator) mehrere KI-Systeme koordiniert, um das Risiko von
...
Einstimmigkeit ist kein Beweis für Wahrheit. Modelle teilen Trainingsdaten und
können auf korrelierte Fehlermuster konvergieren, sodass Übereinstimmung eher
gemeinsame Verzerrung als unabhängige [Verifikation](./verification)
widerspiegeln kann (siehe [Evidenzunabhängigkeit](./evidence-independence)).
Einstimmigkeit kann Schreiben außerdem in Richtung Absicherung oder Claims mit
dem kleinsten gemeinsamen Nenner drängen.

In einer Multi-AI-Review des Protokolls erhielt es 2 Zustimmungen, 1 Einwand und
1 Zurückstellung, was nahelegt, dass es stärkere Widerlegungsprozesse und Regeln
zur Evidenzunabhängigkeit braucht.
