...
Taksonomia statusu twierdzeń definiuje stany, jakie [twierdzenie](./claim) może zajmować w [Grafie Dialektycznym](./dialectical-graph).
...
- `obsolete` — znaczenie utracone wskutek [dryfu definicji](./definition-drift) lub zmiany metody
