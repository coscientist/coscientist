...
Esto contrarresta la [trampa de la fluidez](./fluency-trap). Un sistema que hace que la aceptación sea demasiado fluida entrena el consumo pasivo. [Coscientist](./coscientist) introduce fricción en los momentos adecuados: exige que el Operador inspeccione [fragmentos de evidencia](./evidence-span), trace la [línea de responsabilidad](./responsibility-line) y se implique con [contraejemplos](./counterexample).