...
Akıcılık tuzağı, akıcı ve kendinden emin tınlayan nesri doğru kabul etme bilişsel yanlılığıdır. [LLM'ler](./llm) makul bir sonraki token'ları optimize ettiği için, çıktıları yanlış olduğunda bile çoğu zaman iyi okunur. Akıcılık, alttaki doğrulama olmadan uzmanlığın yüzey özelliklerini taklit eder.
