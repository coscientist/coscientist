...
Cette distinction est cruciale pour la [synthèse de connaissances](./knowledge-synthesis). Si vous récupérez deux sources qui « semblent liées » mais sans pouvoir dire si elles sont d’accord ou en conflit, la synthèse s’effondre en simple résumé. Les arêtes typées font du conflit un objet explicite qui peut être cartographié, résolu ou consigné.