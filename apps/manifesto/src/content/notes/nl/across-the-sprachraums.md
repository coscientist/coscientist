...
"Across the Sprachraums" is de visie van [Sunghyun Cho](./sunghyun-cho) op kennissystemen die taalgrenzen overstijgen. De frase combineert een Engels voorzetsel met een Duits zelfstandig naamwoord om zijn eigen betekenis te belichamen: geen enkele [Sprachraum](./sprachraum) zou moeten beperken hoe kennis stroomt.

De visie heeft drie onderdelen:

- Het taalkundige universum doorkruisen — kennis moet toegankelijk zijn ongeacht de taal.
- Ideeën loskoppelen van taal — ideeën behoren toe aan de mensheid, niet aan de tong die ze als eerste uitdrukte.
- [Inter-Sprachraum-communicatie](./inter-sprachraum-communication) — dialoog mogelijk maken over taaldomeinen heen zonder nuance te verliezen.
