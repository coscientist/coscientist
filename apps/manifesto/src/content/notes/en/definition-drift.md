...
In [Coscientist](./coscientist), drift is tracked explicitly by separating
definition objects from claims. When a term changes meaning, old claims can be
marked obsolete due to [meaning loss](./meaning-loss) or re-scoped instead of
being silently mixed into a single "consensus."
