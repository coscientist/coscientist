...
Enzyklopädie-Meltdown ist ein Wissenskollaps-Fehlermodus, der beginnt, wenn Initiative und Kontrolle des Schreibens ohne bewusstes Eingreifen des [Operators](./operator) auf KI übergehen. Der Begriff stammt aus einem Essay von [Sunghyun Cho](./sunghyun-cho).

Der Meltdown entsteht typischerweise aus drei gekoppelten Schleifen:

1. **Generierung → Zitation**: Modellausgaben werden wieder in den Korpus eingespeist und später zitiert, als wären sie externe Fakten.
2. **Verknüpfung → Autorität**: Interne Links funktionieren nicht mehr als Verifikationspfade, sondern werden zu Vertrauensabzeichen, sodass Linkdichte Genauigkeit ersetzt.
3. **Verantwortung → kein Akteur**: Wenn unklar ist, wer was auf welcher Grundlage behauptet hat, wird Korrektur teuer, und das System stabilisiert sich um einen „annähernd aufrechterhaltenen" falschen stationären Zustand.
