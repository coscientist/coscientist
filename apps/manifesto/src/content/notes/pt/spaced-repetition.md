...
A repetição espaçada é uma forma baseada em evidências de programar revisões para que você pratique a recuperação (recall) pouco antes de esquecer. Ela aproveita o [efeito do espaçamento](./spacing-effect) e o formato da [curva do esquecimento](./forgetting-curve): os intervalos se expandem quando você lembra e se contraem quando não.
