---
title: Systemdrift
description: Degradierung von Wissenssystemen durch Selbstkontamination oder Vernachlässigung
---

Systemdrift ist die Kategorie von [Driftphänomenen](./drift-phenomena), bei der das Wissenssystem selbst im Laufe der Zeit degradiert — unabhängig von semantischen oder umweltbedingten Veränderungen.

## Formen

- [Modellkollaps](./model-collapse) — Degradierung durch Training auf KI-generierten Daten
- [Korrektur vs. Drift](./correction-vs-drift) — wenn das Beheben von Fehlern mehr kostet, als sie sich ausbreiten zu lassen
...
- [Institutionelles Brain Rot](./institutional-brain-rot) — organisatorisches Analogon