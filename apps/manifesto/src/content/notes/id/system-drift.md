...
Drift sistem adalah kategori dari [fenomena drift](./drift-phenomena) ketika sistem pengetahuan itu sendiri memburuk seiring waktu, terlepas dari perubahan semantik maupun lingkungan.

## Bentuk

- [Kolaps Model](./model-collapse) — degradasi akibat pelatihan pada data yang dihasilkan AI
- [Koreksi vs Drift](./correction-vs-drift) — ketika memperbaiki kesalahan lebih mahal daripada membiarkannya menyebar
