...
W tym Manifeście ciemna noc jest także metaforą cywilizacyjnego lub epistemicznego kolapsu. Upadek [Imperium Galaktycznego](./galactic-empire) u [Isaaca Asimova](./isaac-asimov) to cywilizacyjna ciemna noc, a [Encyklopedyczne załamanie](./encyclopedia-meltdown) jest analogią dla systemu wiedzy: gdy weryfikacja się załamuje, system wymaga odbudowy, a nie dopisywania kolejnych tekstów. Taka [arka wiedzy](./knowledge-ark) jak fikcyjna [Encyclopedia Galactica](./encyclopedia-galactica) to jeden ze sposobów, by przebyć tę noc; [Coscientist](./coscientist) stara się to zrobić bez rezygnacji z suwerenności.