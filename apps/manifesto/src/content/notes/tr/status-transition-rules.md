...
Durum geçiş kuralları, bir [iddianın](./claim) [iddia durum taksonomisinde](./claim-status-taxonomy) bir durumdan diğerine neyin taşıdığını tanımlar. Geçişler sayıya değil, meydan okumanın türüne bağlıdır: tek bir belirleyici [karşı-örnek](./counterexample), ikna edici olmayan pek çok itirazdan daha önemlidir.
