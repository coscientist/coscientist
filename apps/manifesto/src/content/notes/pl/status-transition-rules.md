...
Reguły przejść statusu określają, co przenosi [roszczenie](./claim) z jednego stanu do innego w [taksonomii statusu roszczeń](./claim-status-taxonomy). Przejścia zależą od typu wyzwania, a nie od liczby: pojedynczy rozstrzygający [kontrprzykład](./counterexample) ma większe znaczenie niż wiele nieprzekonujących zastrzeżeń.
