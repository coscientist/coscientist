...
To rozdzielenie ma znaczenie, ponieważ wiedza ewoluuje, ale dokumenty pozostają. Jeśli traktujesz dokument jako źródło prawdy, może on stać się nieaktualny lub wprowadzać w błąd, gdy graf się aktualizuje. Traktując narracje jako migawki, [Coscientist](./coscientist) jasno pokazuje, że proza jest pochodna, a nie pierwotna.

Każde zdanie w narracji powinno dać się prześledzić wstecz przez [twierdzenia](./claim), [fragmenty dowodowe](./evidence-span) i [źródła](./source). Bez tego łańcucha zdanie pozostaje tylko zdaniem, a nie zweryfikowaną wiedzą.