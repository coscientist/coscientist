...
Krach Encyklopedii to tryb awarii polegający na załamaniu wiedzy, który zaczyna się wtedy, gdy inicjatywa i kontrola nad pisaniem przesuwają się na AI bez świadomej interwencji [Operatora](./operator). Termin pochodzi z eseju autorstwa [Sunghyuna Cho](./sunghyun-cho).

Krach zazwyczaj wyłania się z trzech sprzężonych pętli:

1. **Generowanie → cytowanie**: wyniki modelu są ponownie wchłaniane do korpusu i później cytowane tak, jakby były faktami zewnętrznymi.
2. **Linkowanie → autorytet**: linki wewnętrzne przestają działać jako ścieżki weryfikacji i stają się odznakami zaufania, więc gęstość linków zastępuje dokładność.
3. **Odpowiedzialność → brak podmiotu**: gdy nie wiadomo, kto co stwierdził i na jakiej podstawie, korekta staje się kosztowna, a system stabilizuje się wokół „w przybliżeniu utrzymywanego” fałszywego stanu równowagi.
