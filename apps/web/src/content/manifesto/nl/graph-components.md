...
description: De knoop- en randtypen die een dialectische graaf vormen
sourceLocale: en
...
- [Reikwijdte](./scope) — toepassingsvoorwaarden
- [Aanname](./assumption) — impliciete premissen
- [Methode](./method) — procedures voor het genereren van bewijs
- [Bron](./source) — herkomstankers
...
- [Controverse](./contention) — gestructureerde conflictaanduidingen
