...
È collegata ma distinta dalla [ricerca prima delle confutazioni](./rebuttal-first-search), che è un protocollo di validazione per accettare le affermazioni. La ricerca prima dei controesempi è una strategia di scoperta: cercare attivamente ciò che si rompe, piuttosto che ciò che conferma.