...
Pewność w [Coscientist](./coscientist) nie jest pojedynczym wynikiem prawdopodobieństwa. To wielowymiarowy status, który odzwierciedla, jak [twierdzenie](./claim) przetrwało wnikliwą ocenę: jakie rodzaje dowodów je wspierają, jakie wyzwania przetrwało oraz jak solidna jest struktura jego ścieżek.
