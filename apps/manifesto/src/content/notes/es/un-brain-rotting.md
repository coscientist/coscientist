...
description: Proceso activo de restaurar la capacidad de verificación y la agencia en un entorno informativo posterior a la IA
---

Despodrir el cerebro es el proceso activo de restaurar la capacidad de verificación y la agencia cognitiva tras la exposición a entornos informativos degradados. Es lo contrario de la deriva: en lugar de absorber pasivamente [basura de IA](./ai-slop) y tratar la fluidez como verdad, el usuario reconstruye deliberadamente los hábitos de escrutinio, citación de fuentes y refutación.
