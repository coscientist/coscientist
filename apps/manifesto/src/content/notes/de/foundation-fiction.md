...
- [Wissens-Arche](./knowledge-ark) — Archive, die darauf ausgelegt sind, einen Kollaps zu überstehen

## Zentrale Erkenntnis

- [Von Bewahrung zu Fähigkeit](./from-preservation-to-capability) — der Wandel vom Speichern hin zum Erzeugen von Verständnis

Die fiktive Enzyklopädie ist ein Design-Ziel: Was bräuchte es, um ein reales System zu bauen, das eine von KI gesättigte epistemische Umgebung überstehen und dennoch echtes Wissen hervorbringen kann?