...
description: Zasada, według której twierdzenia są akceptowane tylko wtedy, gdy wszyscy recenzenci się zgadzają
---

Wymóg jednomyślności to zasada w [Protokole Konsensusu Multi-AI](./multi-ai-consensus-protocol), zgodnie z którą [twierdzenia](./claim) są akceptowane tylko wtedy, gdy wszystkie uczestniczące systemy AI wyrażają zgodę. Rozbieżności między modelami traktuje się jako sygnał wymagający bliższej analizy, a nie jako szum, który należy uśrednić.
