...
Bagi [Coscientist](./coscientist), ini berarti [Graf Dialektik](./dialectical-graph) harus mampu merepresentasikan klaim dari sumber-sumber bahasa yang berbeda, melacak kapan ketidaksepakatan yang tampak sebenarnya merupakan artefak terjemahan, dan menampilkan [pertentangan](./contention) yang autentik yang melampaui ekspresi linguistik. Sistem harus membedakan antara "mereka tidak sepakat karena mereka menggunakan kata-kata secara berbeda" dan "mereka tidak sepakat karena mereka memiliki bukti yang berbeda."

Inilah juga alasan mengapa [pengindeksan agnostik bahasa](./language-agnostic-indexing) itu penting: tulang punggung konseptualnya harus cukup kokoh untuk menjadi titik temu bagi gagasan yang diekspresikan dalam bahasa apa pun.