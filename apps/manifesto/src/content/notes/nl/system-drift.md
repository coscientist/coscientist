...
Systeemdrift is de categorie van [driftfenomenen](./drift-phenomena) waarbij het kennissysteem zelf in de loop van de tijd degradeert, onafhankelijk van semantische of omgevingsveranderingen.

## Vormen

- [Modelinstorting](./model-collapse) — degradatie door training op door AI gegenereerde data
- [Correctie versus drift](./correction-vs-drift) — wanneer het oplossen van fouten meer kost dan ze te laten voortwoekeren
...
- [Institutionele brain rot](./institutional-brain-rot) — organisatorische analogie
