...
The unanimity requirement is the rule in the [Multi-AI Consensus Protocol](./multi-ai-consensus-protocol) that [claims](./claim) are accepted only when all participating AI systems agree. Disagreement among models is treated as a signal for closer inspection, not as noise to be averaged away.
