...
과정이다. 이는 수동적인 수용이 아니다. 검증에는 노력이 필요하며, 그 노력이야말로
지식을 믿음과 구분 짓는다.
...
[다중-AI 합의 프로토콜](./multi-ai-consensus-protocol)(다중 AI 합의 프로토콜)은
여기에 사회적 차원을 더한다. 모델들 간의 불일치는 더 많은 정밀 검토가 필요하다는
신호로 취급된다.

더 온전한 구현 프레이밍을 위해서는 [검증 시스템](./verification-system)을 참고하라.
