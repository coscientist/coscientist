...
La couche d’inférence est le réseau vivant et évolutif de [revendications](./claim), d’[attaques](./attack), de [réfutations sous-jacentes](./undercut) et de relations de soutien dans un [Graphe dialectique](./dialectical-graph). Elle représente l’état actuel des connaissances : ce qui est cru, ce qui est contesté et ce qui a été réfuté.
