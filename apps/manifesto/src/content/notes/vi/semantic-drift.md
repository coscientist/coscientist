...
Trôi dạt ngữ nghĩa là một nhóm trong [các hiện tượng trôi dạt](./drift-phenomena), nơi ý nghĩa của các thuật ngữ dịch chuyển theo thời gian hoặc giữa các cộng đồng, khiến các khẳng định trở nên lỗi thời, gây hiểu lầm, hoặc mâu thuẫn giả tạo.

## Các dạng

- [Trôi dạt định nghĩa](./definition-drift) — khi ý nghĩa của một thuật ngữ thay đổi theo thời gian hoặc theo ngữ cảnh
- [Mất ý nghĩa](./meaning-loss) — khi một khẳng định trở nên lỗi thời vì các thuật ngữ của nó đã thay đổi
