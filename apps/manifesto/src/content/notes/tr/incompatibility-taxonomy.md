...
Uyumsuzluk taksonomisi, kaynakların neden anlaşamadığını sınıflandırır. Kategoriler; tanım farklılıklarını (aynı kelime, farklı kavramlar), örnekleme farklılıklarını (farklı popülasyonlar veya koşullar), yöntem farklılıklarını (farklı prosedürler), kapsam kaymasını (farklı bağlamlara uygulanan iddialar) ve [nonstationarity](./nonstationarity)’yi (çalışmalar arasında dünya değişti) içerir.
