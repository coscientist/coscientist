...
description: Protokoll, um unterschiedliche Quellen dazu zu zwingen, sich mit den Behauptungen der jeweils anderen auseinanderzusetzen
---

Dokumentenkollision ist das Protokoll, das unterschiedliche Quellen dazu zwingt, sich mit den [Behauptungen](./claim) der jeweils anderen auseinanderzusetzen, statt sie lediglich parallel zusammenzufassen. Wenn Dokumente kollidieren, werden Widersprüche sichtbar, Definitionen müssen angeglichen werden, und [Streitpunkte](./contention) werden als explizites Objekt offengelegt.
